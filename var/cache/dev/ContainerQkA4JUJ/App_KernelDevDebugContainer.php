...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ChatController']);
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, $b, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['doctrine_mongodb.odm.document_value_resolver'] ?? $container->load('getDoctrineMongodb_Odm_DocumentValueResolverService'));
    ...
    private $loadedDynamicParameters = [
        ...
        'voyage.endpoint' => false,
        'voyage.batch_size' => false,
        'voyage.max_retries' => false,
        'openai.api_key' => false,
        'openai.api_url' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'voyage.api_key' => $container->getEnv('VOYAGE_API_KEY'),
            'voyage.endpoint' => $container->getEnv('VOYAGE_ENDPOINT'),
            'voyage.batch_size' => $container->getEnv('int:BATCH_SIZE'),
            'voyage.max_retries' => $container->getEnv('int:MAX_RETRIES'),
            'openai.api_key' => $container->getEnv('OPENAI_API_KEY'),
            'openai.api_url' => $container->getEnv('OPENAI_API_URL'),
